...
all: src/game.S src/main.S src/message_ws.S src/message_tcp.S src/game.o system/crt0.o system/ines.o src/main.o src/message_ws.o src/message_tcp.o chr/tiles.o game_ws.nes game_tcp.nes
...
game_tcp.nes: system/ld65.cfg chr/tiles.o src/main.o system/ines.o system/crt0.o src/game.o src/message_tcp.o
	$(LD) -o $@ -C system/ld65.cfg --dbgfile game_ws.dbg --mapfile game_ws.map src/game.o src/message_tcp.o system/crt0.o system/ines.o src/main.o chr/tiles.o /home/sylvain/workspace/nes/n++/gcc-6502-bits/gcc-build/6502/libgcc/libgcc.a /home/sylvain/workspace/nes/n++/gcc-6502-bits/libtinyc/libtinyc.a
